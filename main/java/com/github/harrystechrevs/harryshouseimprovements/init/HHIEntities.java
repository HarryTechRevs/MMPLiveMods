...
{
	public static EntityType<?> chair = EntityType.Builder.create(ChairEntity::new, EntityClassification.MISC).size(1.0f, 0.3f).setCustomClientFactory((spawnEntity, world) -> new ChairEntity(world)).build(HarrysHouseImprovements.MODID + ":chair_entity").setRegistryName(HHIRegistries.location("chair_entity"));;
